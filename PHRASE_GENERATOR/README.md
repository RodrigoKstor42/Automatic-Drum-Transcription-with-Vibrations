...
- En base a lo que hemos avanzado y estudiado el repositorio donde esta el modelo donde se va a introducir estos datos, se pudo averiguar que las anotaciones que se generaron de cada archivo WAV debe estar en .txt, aunque los JSON que tenemos actualmente tambien son utiles y deben conservarse
